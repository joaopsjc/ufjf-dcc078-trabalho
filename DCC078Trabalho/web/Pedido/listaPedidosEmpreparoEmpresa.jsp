                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row toolbar-crud-grid">
                            <button onclick="UF.Empresa.FinalizarPedido(this)" class="btn btn-success" type="button"><i class="fa fa-check"></i> Preparo Finalizado</button>
                        </div>
                        <table id="pedidos-finalizados-grid-resumo"class="table table-bordered">
                            <thead>
                            <tr>
                                <th class="table-th-check"><input type="checkbox"  class="i-checks" id="pedidos-finalizados-grid-resumo-check-all" name="check-grid"></th>
                                <th>Restaurante</th>
                                <th>Cliente</th>
                                <th>Entregador</th>
                                <th>Frete</th>
...
<script>
        $(document).ready(function(){
            ...
            UF.Helpers.SetCheckAllGrid('pedidos-finalizados-grid-resumo');
        });
</script>