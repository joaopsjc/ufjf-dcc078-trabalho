...
<head>
    ...
    <title><c:out value="${initParam.systemName}"/> | Erro</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center animated fadeInDown">
        <h1>500</h1>
        <h3 class="font-bold">Ocorreu um erro inesperado</h3>

        <div class="error-desc">
            Retornar à página inicial<br/><a href="FrontController?action=Home" class="btn btn-primary m-t">Home</a>
        </div>
    </div>
